...
<body>
    ...
    <main>
        <section class="embedded">
            ...
            <p><strong><a href="<?= ($UserLogged) ? 'contact.php?state=4' : 'login.php?state=login'; ?>">Contact me</a></strong> to discuss your project and discover how we can help you achieve your technological goals.</p>
        </section>
        <section class="web">
            ...
            <p><strong><a href="<?= ($UserLogged) ? 'contact.php?state=4' : 'login.php?state=login'; ?>">Contact me</a></strong> today to start building a web solution that elevates your online presence!</p>
        </section>
    </main>
    <?php
